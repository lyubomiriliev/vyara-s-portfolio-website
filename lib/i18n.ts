...
export const translations = {
  en: {
    ...
    about: {
      ...
      teamSectionSub: "Two co-founders. One shared vision. Zero compromise on results.",
      founder1Name: "Vyara Ivanova-Ilieva",
      founder1Role: "Co-Founder & Head of Marketing",
      founder1Bio: "Vyara is the strategic and creative force behind Aviva Digital. With years of experience in AI-powered marketing, social media growth, and brand building, she turns ideas into campaigns that actually move the needle.",
      ...
      founder2Bio: "Lyubomir architects the technical backbone of everything Aviva Digital builds. From lightning-fast websites to custom web apps, he bridges design and engineering to deliver digital products that look great and perform even better.",
  ...
  bg: {
    ...
    about: {
      ...
      teamSectionSub: "Двама съосновател. Една обща визия. Нулев компромис с резултатите.",
      founder1Name: "Вяра Иванова-Илиева",
      founder1Role: "Съосновател и ръководител маркетинг",
      founder1Bio: "Вяра е стратегическата и творческа сила зад Aviva Digital. С години опит в AI маркетинга, ръста на социалните мрежи и изграждането на брандове, тя превръща идеите в кампании, които наистина дават резултати.",
      ...
      founder2Bio: "Любомир изгражда техническата основа на всичко, което Aviva Digital създава. От светкавично бързи уебсайтове до персонализирани уеб приложения, той свързва дизайна с инженерството за дигитални продукти, които изглеждат страхотно и работят още по-добре.",
