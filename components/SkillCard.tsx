  ...
  return (
    <div className={clsx(baseStyle, variantStyles[variant])}>
      <div className="relative w-full h-full [transform-style:preserve-3d] transition-all duration-500 group-hover:[transform:rotateY(180deg)]">
        {/* Front Face */}
        <div className="absolute w-full h-full bg-cardBG border-textGray/10 border-[1px] p-5 flex flex-col justify-center text-center md:text-left items-center md:items-start space-y-4 rounded-xl [backface-visibility:hidden]">
          <Image
            width={600}
            height={600}
            src={img}
